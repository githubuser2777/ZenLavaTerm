...
| `packaging/scoop/lavaterm.json` | Scoop Bucket Manifest | Windows | [Scoop](https://scoop.sh/) |
| `packaging/winget/` | Windows Package Manager | Windows | [winget-pkgs](https://github.com/microsoft/winget-pkgs) |
