...
wget https://github.com/githubuser2777/ZenLavaTerm/releases/latest/download/lavaterm-0.11.0-1-x86_64.pkg.tar.zst

# 2. Install using pacman
sudo pacman -U lavaterm-0.11.0-1-x86_64.pkg.tar.zst
```
